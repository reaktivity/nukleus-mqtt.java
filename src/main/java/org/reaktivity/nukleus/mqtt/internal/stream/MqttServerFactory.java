...
public final class MqttServerFactory implements StreamFactory
{
    ...
    private final class MqttServer
    {
        ...
        private void cleanupPublishersIfNecessary(
            long traceId,
            long authorization)
        {
        ...
        private final class MqttPublishStream extends MqttServerStream
        {
                ...
                SignalFW signal)
            {
                ...
                doRequestEnd(traceId, authorization, endEx);
            }
            ...
            private void doRequestEnd(
                ...
                Flyweight extension)
            {
                if (!MqttState.initialOpened(state) || requestSlot != NO_SLOT)
                {
                ...
                Flyweight extension)
            {
                ...
                doAbort(application, routeId, replyId, traceId, authorization, extension);
            }
        ...
        private final class MqttSubscribeStream extends MqttServerStream
        {
                ...
                DataFW data)
            {
                ...
                final MqttDataExFW dataEx = mqttDataExRO.tryWrap(exBuffer, exOffset, exOffset + exLength);
            ...
            // TODO - finish setting up MqttState for the server
            private void setRequestClosed()
            {
                assert !MqttState.initialClosed(state);

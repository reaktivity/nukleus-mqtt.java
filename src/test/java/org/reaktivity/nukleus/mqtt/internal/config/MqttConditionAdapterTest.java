...
public class MqttConditionAdapterTest
{
    ...
    public void initJson()
    {
        JsonbConfig config = new JsonbConfig()
                .withAdapters(new MqttConditionAdapter());
    ...
    public void shouldReadCondition()
    {
        ...
        MqttCondition condition = jsonb.fromJson(text, MqttCondition.class);
    ...
    {
        MqttCondition condition = new MqttCondition("test", SUBSCRIBE_ONLY);
